...
//      For other notes on the revision history, see the changelog file
//      which should have come with the code and can also be found at
//      the ToyFDTD website.
///////////////////////////////////////////////////////////////////////////////
...
void join(void* thread) {
  gm::Thread* jthread = (gm::Thread*)thread;
  jthread->join();
  delete(jthread);
}
